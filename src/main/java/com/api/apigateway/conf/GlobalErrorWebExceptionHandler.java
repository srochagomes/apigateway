...
import com.api.apigateway.conf.exceptions.CustomizeBusinessException;
import com.api.apigateway.conf.exceptions.ThrowableExceptionCustom;
...
public class GlobalErrorWebExceptionHandler implements ErrorWebExceptionHandler, AccessDeniedHandler, ServerAuthenticationFailureHandler, ServerAccessDeniedHandler, ServerAuthenticationEntryPoint {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        customizeBusinessException.setStatusCode(HttpStatus.resolve(exchange.getResponse().getStatusCode().value()));
    ...
    private String getTraceID() {
        String traceId = Optional.ofNullable(MDC.get(TRACE_ID_KEY)).orElse("");
